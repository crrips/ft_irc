...
User::User(int fd, std::string &hostname, std::string const &nickname, std::string const &username) : _FileDescriptor(fd), _HostName(hostname), _Nickname(nickname), _UserName(username)
{
